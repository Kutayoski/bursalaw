SEO başlığı: Bir Hizmet Açık Rıza Şartına Bağlanabilir mi?

Meta açıklaması: Bir hizmet için zorunlu olmayan pazarlama, profil çıkarma veya aktarım faaliyetlerine rıza vermek asıl hizmetin şartı yapılamaz. Ancak isteğe bağlı.

Önerilen URL: /kvkk/hizmetin-acik-rizaya-baglanmasi

Birincil anahtar kelime: hizmetin açık rızaya bağlanması

İkincil sorgular: zorunlu açık rıza; rıza vermezsem hizmet alamaz mıyım; koşullu rıza

# Bir Hizmet Açık Rıza Şartına Bağlanabilir mi?

Bir hizmet için zorunlu olmayan pazarlama, profil çıkarma veya aktarım faaliyetlerine rıza vermek asıl hizmetin şartı yapılamaz. Ancak isteğe bağlı ek bir programın kendi işleyişi için gerçekten gerekli veri işlemesi farklı değerlendirilebilir.
...
Bir hava yolu, bilet satın alan yolcuya uçuş içi interneti yalnız reklam profillemesine izin verirse açar. İnternet hizmeti bu profilleme olmadan da sunulabiliyorsa pazarlama rızası hizmetin ön şartı yapılamaz; yolcu reddettiğinde temel hizmete erişebilmelidir.
...
### Kurulun 15 Haziran 2023 tarihli, 2023/1041 sayılı kararı

İnternet sitesinde aydınlatma ve hizmetin rızaya bağlanması incelendi. Kurul, alternatif satış kanalının anlaşılmasını neredeyse imkansız kılan tasarımı şeffaf bulmadı ve alternatifin üyelik ile satış ekranlarında açıkça gösterilmesini istedi. Bu yazı bakımından karar, hukuki dayanak ile ölçülülüğün birlikte incelenmesi gerektiği yönünü açıklığa kavuşturur. Kararın tam metni YARGI PRO üzerinden getirilerek tarih, sayı, olay, sonuç ve gerekçe birlikte doğrulanmıştır. [Resmi karar metni](https://www.kvkk.gov.tr/Icerik/7768/2023-1041)

### Kurulun 15 Ağustos 2024 tarihli, 2024/1393 sayılı kararı

Uçuş sırasında sunulan internet hizmetinde zorunlu onay akışı incelendi. Kurul, hizmet için gerekli olmayan veri işlemeyi açık rıza şartına bağlayan ve kullanıcıyı yanıltan akışın özgür iradeyi sakatladığını; aydınlatma iddiasının ise önce veri sorumlusuna yöneltilmesi gerektiğini belirtti. Bu yazı bakımından karar, aydınlatma, güvenlik ve ispat yükümlülüklerinin birbirinden bağımsız olduğu yönünü açıklığa kavuşturur. Kararın tam metni YARGI PRO üzerinden getirilerek tarih, sayı, olay, sonuç ve gerekçe birlikte doğrulanmıştır. [Resmi karar metni](https://www.kvkk.gov.tr/Icerik/8885/2024-1393)

### Kurulun 25 Mayıs 2023 tarihli, 2023/890 sayılı kararı

Havayolunun özel yolcu programında açık rıza değerlendirilmiştir. Kurul, asıl taşıma hizmetine alternatif olan isteğe bağlı program bakımından, somut tasarımda rızanın hizmetin ön şartı sayılmadığı sonucuna vardı. Bu yazı bakımından karar, veri işleme sona erdiğinde düzeltme, sınırlama veya imha adımının belgelenmesi gerektiği yönünü açıklığa kavuşturur. Kararın tam metni YARGI PRO üzerinden getirilerek tarih, sayı, olay, sonuç ve gerekçe birlikte doğrulanmıştır. [Resmi karar metni](https://www.kvkk.gov.tr/Icerik/7760/2023-890)

### Kararların soruya verdiği net cevap

Kurulun yaklaşımı biçimsel bir onay kutusundan çok gerçek veri akışına odaklanır. Hukuki sebep bulunması, ölçüsüz veri toplamayı veya zayıf güvenliği meşrulaştırmaz. Güncel eğilim; aydınlatmanın somutlaştırılması, rıza ile diğer dayanakların ayrılması, daha az müdahaleci alternatiflerin seçilmesi ve yapılan işlemlerin belgeyle ispatlanması yönündedir. İstisna veya özel mevzuat varsa kapsamı yalnız zorunlu veriyle sınırlıdır. Bu nedenle hizmetin açık rızaya bağlanması sorusunun cevabı, kuruluşun amacı ve dayanağı kayıtlarla gösterebilmesine bağlıdır; genel ifadeler tek başına yeterli değildir.
...
- [Kurul kararı, 2023/1041](https://www.kvkk.gov.tr/Icerik/7768/2023-1041)
- [Kurul kararı, 2024/1393](https://www.kvkk.gov.tr/Icerik/8885/2024-1393)
- [Kurul kararı, 2023/890](https://www.kvkk.gov.tr/Icerik/7760/2023-890)

Karar doğrulama notu: Kurul 2023/1041, Kurul 2024/1393, Kurul 2023/890 tam metinleri YARGI PRO üzerinden getirilmiş; kimlik, olay, sonuç ve gerekçe kontrol edilmiştir.
