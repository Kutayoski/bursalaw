SEO başlığı: Dijital Oyun ve Platformlarda Veri İhlali Olursa Ne Yapılır?

Meta açıklaması: Hesap verileri sızdığında yalnız parola sıfırlamak yeterli değildir. Olayın kapsamı, giriş noktası, etkilenen kişi ve veri kategorileri belirlenmeli;.

Önerilen URL: /kvkk/dijital-platform-veri-ihlali

Birincil anahtar kelime: dijital platform veri ihlali

İkincil sorgular: oyun hesabı veri sızıntısı; platform hacklendi; kullanıcı verisi ihlali

# Dijital Oyun ve Platformlarda Veri İhlali Olursa Ne Yapılır?

Hesap verileri sızdığında yalnız parola sıfırlamak yeterli değildir. Olayın kapsamı, giriş noktası, etkilenen kişi ve veri kategorileri belirlenmeli; risk varsa Kurula ve ilgili kişilere gecikmeden bildirim yapılmalıdır.
...
Bir oyun platformunda eski bir API açığı kullanıcı adları, e-postalar ve şifre özetlerini dışarı sızdırır. Şirket API'yi kapatıp parola sıfırlamanın yanında logları korumalı, etkilenen hesapları belirlemeli ve 72 saatlik Kurul bildirimi gerekliliğini olay bazında kayda bağlamalıdır.
...
- [Kurul kararı, 2023/1017](https://www.kvkk.gov.tr/Icerik/8864/2023-1017)
- [Kurul kararı, 2023/1645](https://www.kvkk.gov.tr/Icerik/7765/2023-1645)
- [Kurul kararı, 2024/728](https://www.kvkk.gov.tr/Icerik/8858/2024-728)

Karar doğrulama notu: Kurul 2023/1017, Kurul 2023/1645, Kurul 2024/728 tam metinleri YARGI PRO üzerinden getirilmiş; kimlik, olay, sonuç ve gerekçe kontrol edilmiştir.
